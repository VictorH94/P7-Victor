...
// Fonction composant CollapseItem permettant à l'utilisateur quand il clique sur la flèche en bas pour faire apparaitre du texte de description ou quand il clique sur la flèche en haut de faire disparaitre le texte de description.
function CollapseItem({title, description}) {
  const [collapsed, setCollapsed] = useState(false)          //Déclare une nouvelle variable d'état que l'on appelle "collapsed". On initialise l'état de collapse à false
